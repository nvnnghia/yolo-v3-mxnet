...
def parse_args():
    ...
    parser.add_argument('--video', dest='video', type=str, default='VIDEO3.mp4',
...
#KCF track
	if(kcf):
		...
		cv2.rectangle(framekcf,(boundingbox[0],boundingbox[1]), (boundingbox[0]+boundingbox[2],boundingbox[1]+boundingbox[3]), (255,255,0), 1)
		if objecta.label == 0:
			st +=1
		if objecta.label == 1:
			sit +=1
